...
[点击这里](https://github.com/x-liao/awesome-chatgpt-prompts-zh/edit/main/README.md) 可以将您自己的调教指南添加到列表中。
...
如需编程请使用https://github.com/x-liao/awesome-chatgpt-prompts-zh/blob/main/prompts-zh.json 
...
[![Star History Chart](https://api.star-history.com/svg?repos=x-liao/awesome-chatgpt-prompts-zh&type=Date)](https://star-history.com/#PlexPt/awesome-chatgpt-prompts-zh&Date)
